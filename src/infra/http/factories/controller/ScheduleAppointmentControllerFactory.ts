...
import {
  IScheduleAppointmentControllerRequest,
  ScheduleAppointmentController,
} from "@modules/appointment/application/useCases/ScheduleAppointment/ScheduleAppointmentController";

export function makeScheduleAppointmentControllerFactory(): IController<IScheduleAppointmentControllerRequest> {
